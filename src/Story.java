public class Story extends Thread{
    ...
    public void ending(){
        ...
        System.out.println("골리앗은 땅바닥에 얼굴을 박고 쓰러졌습니다.");
        System.out.println("다윗의 승리는 모든 이들에게 큰 용기와 희망을 안겨주었습니다. 그의 용기와 믿음은 " +
                "\n사람들에게 이기적인 힘만이 아닌 올바른 길을 선택하고 신뢰하는 것의 중요성을 상기시켰습니다.\n" +
                "골리앗을 물리침으로써 다윗은 자신의 한계를 뛰어넘을 수 있다는 것을 보여주었고, 이는 앞으로의 도전에 대한 대비와 자신감을 심어주었습니다.\n\n");
        System.out.println("+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+\n\n\n\n\n");
    }
